...
export default defineConfig(({ command, mode }) => {
  ...
  const devAliases: AliasOptions = isDev
    ? {
        "@calenderjs/react": path.resolve(
          rootDir,
          "packages/react/src/index.ts",
        ),
        "@calenderjs/react-event-editor": path.resolve(
          rootDir,
          "packages/react-event-editor/src/index.ts",
        ),
        ...
        "@calenderjs/date-time": path.resolve(
          rootDir,
        ...
        "@calenderjs/monaco-event-dsl": path.resolve(
          rootDir,
          "packages/monaco-event-dsl/src/index.ts",
        ),
      }
    : {};
